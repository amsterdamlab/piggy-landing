...
function initCalculator() {
  ...
  function recalculate() {
    ...
    // Valor por Piggy: $1.200.000 COP
    // 1 Piggy: 8% ($96.000 c/u = $96.000)
    // 2 Piggys: 9% ($108.000 c/u = $216.000)
    // 3+ Piggys: 10% ($120.000 c/u = $360.000 hasta $1.200.000)
    const PIG_PRICE = 1200000;
    let marginRate = 0.10;
    if (pigs === 1) {
      marginRate = 0.08;
    } else if (pigs === 2) {
